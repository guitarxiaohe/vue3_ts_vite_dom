export default {
  ...
  login: {
    ...
    slogan: 'Config-driven, low-code enterprise admin',
    feature1: 'Create table → Configure → Auto-render, no more CRUD',
    feature2: 'AI Chat & LiveKit video conferencing built-in',
    feature3: 'AI assistant builds simple CRUD via conversation',
    feature4: '3-language i18n · Theme switching · Dynamic fields',
  ...
  meeting: {
    ...
    participantJoinedCount: '{count} joined',
    ...
    liveTranscriptPanelTitle: 'Live Captions',
    ...
    backgroundPopupBlocked:
      'The browser blocked the standalone window. Allow pop-ups and try again.',
    backgroundWindowRunning: 'The meeting is running in a standalone window',
    startRtc: 'Start Call',
    stopRtc: 'End Call',
    ...
    shareScreenAction: 'Share Screen',
    stopShareScreen: 'Stop Sharing',
    shareScreenShort: 'Share',
    ...
    noScreenSharing: 'No screen is being shared',
    shareScreenFullscreenMessage:
    ...
    cameraOffShort: 'Off',
    captionAction: 'Captions',
    captionShort: 'Captions',
    moreAction: 'More',
    moreShort: 'More',
    ...
    featureConnecting: '{label} is being connected',
    ...
    mobilePanelTabs: 'Meeting side panel tabs',
    mobileTranscriptTab: 'Captions',
    mobileSummaryTab: 'Summary',
    mobileChatTab: 'Chat',
    avatarOverflowTitle: '{count} more',
  },
  notFound: {
  ...
  chatQuestionForm: {
    ...
    resolvedRuleId: 'Resolved Rule ID',
  ...
  entity: {
    ...
    chatQuestion: { title: 'Unmatched Questions' },
  },
  field: {
    id: 'ID',
    status: 'Status',
